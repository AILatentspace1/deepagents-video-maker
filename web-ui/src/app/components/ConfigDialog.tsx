...
export function ConfigDialog({
  ...
  const [langsmithApiKey, setLangsmithApiKey] = useState(
    initialConfig?.langsmithApiKey || DEFAULT_CONFIG.langsmithApiKey || ""
  );
  ...
  return (
    ...
    >
      <DialogContent className="sm:max-w-[525px]">
        <DialogHeader>
          <DialogTitle>Video-Maker Deep Agent Configuration</DialogTitle>
          <DialogDescription>
            Configure the LangGraph deployment for the video-maker DeepAgent.
            Defaults target a local `langgraph dev` server.
          </DialogDescription>
        </DialogHeader>
